...
//! ADR-034 for the three call paths and why they differ.
...
/// ADR-034 for why the three call paths differ.
...
impl FootnoteIndex {
    ...
    pub fn build(blocks: &[Block]) -> Self {
        ...
        // author's text is never silently deleted — ADR-034), the reader's
