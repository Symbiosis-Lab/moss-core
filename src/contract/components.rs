...
pub const COMPONENTS: &[ComponentEntry] = &[
  ...
  <a class="moss-card-grid" href="...">...</a>
        ...
        since: "0",
        description: "Grid-layout container for auto-generated child listings. Collapses to `.moss-cards[data-layout=grid]` in Phase 1c.",
    },
    ComponentEntry {
  ...
  <a class="moss-card-list" href="...">...</a>
        ...
        status: Status::Confirmed,
        since: "0",
        description: "List-layout container for auto-generated child listings. Collapses to `.moss-cards[data-layout=list]` in Phase 1c.",
    },
    ComponentEntry {
  ...
  <div class="moss-card-minimal">...</div>
    ...
    ComponentEntry {
        ...
        data_attrs: &[],
        example_html: r#"<a class="moss-card-grid" href="...">
  <div class="moss-card-grid-cover">...</div>
  <div class="moss-card-grid-content">...</div>
</a>"#,
        example_markdown: "",
        status: Status::Confirmed,
        since: "0",
        description: "Card instance for grid layout.",
    },
    ComponentEntry {
        ...
        status: Status::Confirmed,
        since: "0",
        description: "Cover image slot inside `.moss-card-grid`. Gets `.moss-card-grid-no-cover` modifier when no image present.",
    },
    ComponentEntry {
        ...
        status: Status::Confirmed,
        since: "0",
        description: "Modifier applied to grid card cover when no image is available.",
    },
    ComponentEntry {
        ...
        status: Status::Confirmed,
        since: "0",
        description: "Text content slot inside grid card (kicker + title + meta).",
    },
    ComponentEntry {
        ...
        status: Status::Confirmed,
        since: "0",
        description: "Eyebrow text above the title in a grid card.",
    },
    ComponentEntry {
        ...
        status: Status::Confirmed,
        since: "0",
        description: "Title in a grid card.",
    },
    ComponentEntry {
        ...
        status: Status::Confirmed,
        since: "0",
        description: "Date/meta line in a grid card.",
    },
    ComponentEntry {
        ...
        data_attrs: &[],
        example_html: r#"<a class="moss-card-list" href="...">
  <div class="moss-card-list-row">...</div>
</a>"#,
        example_markdown: "",
        status: Status::Confirmed,
        since: "0",
        description: "Card instance for list layout.",
    },
    ComponentEntry {
        ...
        status: Status::Confirmed,
        since: "0",
        description: "Row wrapper inside `.moss-card-list` holding cover + body.",
    },
    ComponentEntry {
        ...
        status: Status::Confirmed,
        since: "0",
        description: "Side-cover image slot in a list card.",
    },
    ComponentEntry {
        ...
        status: Status::Confirmed,
        since: "0",
        description: "Text body slot of a list card.",
    },
    ComponentEntry {
        ...
        status: Status::Confirmed,
        since: "0",
        description: "Header row of a list-card body (title + meta).",
    },
    ComponentEntry {
        ...
        status: Status::Confirmed,
        since: "0",
        description: "Eyebrow text above the title in a list card.",
    },
    ComponentEntry {
        ...
        status: Status::Confirmed,
        since: "0",
        description: "Title in a list card.",
    },
    ComponentEntry {
        ...
        status: Status::Confirmed,
        since: "0",
        description: "Date/meta line in a list card.",
    },
    ComponentEntry {
        ...
        status: Status::Confirmed,
        since: "0",
        description: "Excerpt/description paragraph in a list card.",
    },
    ComponentEntry {
  ...
  <a class="moss-prefix-link" href="...">...</a>
        ...
        status: Status::Confirmed,
        since: "0",
        description: "Text-only card instance for minimal listings (blog index, folder views).",
    },
    ComponentEntry {
  ...
  <span class="moss-prefix-link-title">Page title</span>
    ...
    ComponentEntry {
        ...
        parent: "",
        data_attrs: &[],
        example_html: r#"<div class="moss-callout callout callout-note">
  ...
  <div class="callout-content">Body...</div>
        ...
        status: Status::Confirmed,
        since: "0",
        description: "Obsidian-style callout. The Obsidian-compat `.callout` class is co-emitted; type variant lives on `.callout-<type>`.",
    },
    ComponentEntry {
        class: "callout",
        kind: "standalone",
    ...
    ComponentEntry {
        ...
        status: Status::Confirmed,
        since: "0",
        description: "Note-type callout (default neutral styling).",
    },
    ComponentEntry {
        class: "callout-info",
        kind: "instance",
    ...
    ComponentEntry {
        ...
        status: Status::Confirmed,
        since: "0",
        description: "Warning-type callout.",
    },
    ComponentEntry {
        ...
        status: Status::Confirmed,
        since: "0",
        description: "Pending-state callout used by moss for in-progress sections.",
    },
    // -------------------------------------------------------------------
    ...
    ComponentEntry {
        ...
        status: Status::Confirmed,
        since: "0",
        description: "Audio embed variant.",
    },
    ComponentEntry {
        ...
        status: Status::Confirmed,
        since: "0",
        description: "Video embed variant.",
    },
    ComponentEntry {
    ...
    ComponentEntry {
        ...
        status: Status::Confirmed,
        since: "0",
        description: "HTML iframe embed variant.",
    },
    ComponentEntry {
        ...
        status: Status::Confirmed,
        since: "0",
        description: "Jupyter notebook embed variant.",
    },
    ComponentEntry {
    ...
    ComponentEntry {
        ...
        status: Status::Confirmed,
        since: "0",
        description: "CSV/table embed variant.",
    },
    ComponentEntry {
        class: "moss-embed-3d",
        kind: "instance",
        ...
        status: Status::Confirmed,
        since: "0",
        description: "3D model embed variant (glb/gltf).",
    },
    ComponentEntry {
