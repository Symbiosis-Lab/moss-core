...
pub const UNPREFIXED_LEGACY_CLASSES: &[&str] = &[
    ...
    "comment-replies",
    "comment-reply-btn",
    // Unprefixed names moss ships that were governed by nothing until the
    ...
    "review-biblio",
    "review-colophon",
    "review-colophon-details",
    "review-colophon-identity",
    "review-colophon-subtitle",
    "review-colophon-title",
...
pub const COMPONENTS: &[ComponentEntry] = &[
  ...
  <div class="moss-card-minimal">...</div>
    ...
    ComponentEntry {
        ...
        data_attrs: &[],
        example_html: r#"<section class="moss-cards-minimal-year-group minimal">…</section>"#,
        example_markdown: "",
        status: Status::Confirmed,
        since: "0",
        description: "Bare co-class on a minimal year group, alongside the prefixed name. Retained because themes in the wild key on it.",
    },
    ComponentEntry {
  ...
  <span class="moss-prefix-link-title">Page title</span>
    ...
    ComponentEntry {
        class: "title",
        kind: "instance",
        parent: "moss-prefix-link-title",
        data_attrs: &[],
        example_html: r#"<span class="moss-prefix-link-title title">Article Title</span>"#,
        example_markdown: "",
        status: Status::Confirmed,
        since: "0",
        description: "Bare co-class beside `moss-prefix-link-title`, the counterpart of `date` on the prefix span. Both predate the prefixed names and are still emitted for themes that key on them.",
    },
    ComponentEntry {
...
",
  ...
  <div class="moss-grid-card">...</div>
    ...
    ComponentEntry {
        class: "link-preview",
        kind: "instance",
        parent: "moss-grid-card",
        data_attrs: &[],
        example_html: r#"<a href="…" class="moss-grid-card link-preview" target="_blank" rel="noopener">…</a>"#,
        example_markdown: "",
        status: Status::Confirmed,
        since: "0",
        description: "Co-class on a grid card that links out to an external page, alongside `moss-grid-card`. Marks the card as a preview of somewhere else rather than of a page on this site.",
    },
    ComponentEntry {
        ...
        parent: "link-preview",
        data_attrs: &[],
        example_html: r#"<span class="link-preview-title">…</span>"#,
        example_markdown: "",
        status: Status::Confirmed,
        since: "0",
        description: "Title of the linked page inside a link preview.",
    },
    ComponentEntry {
        ...
        parent: "link-preview",
        data_attrs: &[],
        example_html: r#"<span class="link-preview-domain">example.com</span>"#,
        example_markdown: "",
        status: Status::Confirmed,
        since: "0",
        description: "Domain of the linked page, shown so a reader can see where the link goes before following it.",
    },
    ComponentEntry {
        class: "moss-gallery",
        kind: "container",
  ...
  <div class="moss-series-nav-links">...</div>
    ...
    ComponentEntry {
        class: "empty",
        kind: "instance",
        parent: "moss-series-nav-link",
        data_attrs: &[],
        example_html: r#"<span class="moss-series-nav-link moss-series-nav-prev empty"></span>"#,
        example_markdown: "",
        status: Status::Confirmed,
        since: "0",
        description: "Co-class on a series-nav link with nowhere to go — the previous link on the first entry, the next link on the last. The element is still emitted so the pair keeps its layout.",
    },
    ComponentEntry {
  ...
  <div class="moss-field">...</div>
    ...
    ComponentEntry {
        class: "comment-form-slot",
        kind: "instance",
        parent: "moss-comments",
        data_attrs: &[],
        example_html: r#"<div class="comment-form-slot" id="default-form-slot">…</div>"#,
        example_markdown: "",
        status: Status::Confirmed,
        since: "0",
        description: "Placeholder the comment form is rendered into. Kept distinct from the form itself so a reply form can be moved between slots without re-rendering the form.",
    },
    ComponentEntry {
        class: "comment-form",
        kind: "instance",
        parent: "comment-form-slot",
        data_attrs: &[],
        example_html: r#"<form class="comment-form" data-state="idle" id="moss-comment-form">…</form>"#,
        example_markdown: "",
        status: Status::Confirmed,
        since: "0",
        description: "The comment submission form. `data-state` carries the submission lifecycle, so a theme can style submitting and error states without watching the network.",
    },
    ComponentEntry {
        class: "comment-form-meta",
        kind: "instance",
        parent: "comment-form",
        data_attrs: &[],
        example_html: r#"<div class="comment-form-meta"><input class="comment-field" name="name"></div>"#,
        example_markdown: "",
        status: Status::Confirmed,
        since: "0",
        description: "Row holding the commenter identity fields (name, and email where configured), as distinct from the comment body textarea.",
    },
    ComponentEntry {
        class: "comment-form-status",
        kind: "instance",
        parent: "comment-form",
        data_attrs: &[],
        example_html: r#"<div class="comment-form-status" id="moss-comment-status" aria-live="assertive" aria-atomic="true"></div>"#,
        example_markdown: "",
        status: Status::Confirmed,
        since: "0",
        description: "Live region announcing the result of a comment submission. an assertive live region is deliberate: the reader has just acted and is waiting on the answer.",
    },
    ComponentEntry {
        ...
        parent: "comment-form",
        data_attrs: &[],
        example_html: r#"<button type="submit" class="moss-btn comment-form-submit" aria-busy="false">…</button>"#,
        example_markdown: "",
        status: Status::Confirmed,
        since: "0",
        description: "Co-class on the comment form's submit button, alongside `moss-btn`. `aria-busy` tracks the in-flight submission.",
    },
    ComponentEntry {
        class: "comment-field",
        kind: "instance",
        parent: "comment-form-meta",
        data_attrs: &[],
        example_html: r#"<input type="text" name="name" class="comment-field" autocomplete="name" required>"#,
        example_markdown: "",
        status: Status::Confirmed,
        since: "0",
        description: "A text input inside the comment form. Applied to every field so a theme styles them once rather than per name.",
    },
    ComponentEntry {
...
<li id="fn-1" tabindex="-1"><p>The note. <a class="moss-footnote-backref" href="#fnref-1" role="doc-backlink" aria-label="Back to reference 1">&#8617;&#xFE0E;</a></p>
    ...
    ComponentEntry {
        ...
        data_attrs: &[],
        example_html: r##"<aside class="moss-sidenote" id="moss-sidenote-1" popover="auto"><span class="moss-sidenote-number">1</span><p>The note.</p></aside>"##,
        example_markdown: "Text[^1].\n\n[^1]: The note.",
        status: Status::Emerging,
        since: "1",
        description: "A copy of an endnote, built in the browser by `sidenotes.ts` (never emitted by the build) and inserted immediately after its marker, which is `aria-describedby`-linked to it. Two presentations, decided by CSS: in a wide viewport's reserved gutter it floats beside the line that cites it; where no gutter exists it opens as a bottom-sheet popover on marker tap (light dismiss, Esc and exclusivity are the popover API's). Exactly one presentation of each note is rendered — and in the accessibility tree — at a time.",
    },
    ComponentEntry {
    ...
    ComponentEntry {
        class: "moss-sidenote-more",
        kind: "instance",
        parent: "moss-sidenote",
        data_attrs: &[],
        example_html: r##"<button class="moss-sidenote-more">All notes</button>"##,
        example_markdown: "Text[^1].\n\n[^1]: The note.",
        status: Status::Emerging,
        since: "1",
        description: "The peek sheet's handle: a labelled button (localized en/zh-hans/zh-hant), not a grabber, because the sheet is not draggable and a grabber would promise a gesture that does not exist. Its destination is the full glossary — it closes the peek and opens the endnote section as the expanded sheet, with the asked-for note carried a third of the way down, washed and focused. Visible only inside an open peek.",
    },
    ComponentEntry {
        class: "moss-footnote-landed",
        kind: "instance",
        parent: "",
        data_attrs: &[],
        example_html: r##"<aside class="moss-sidenote moss-footnote-landed"><span class="moss-sidenote-number">1</span><p>The note.</p></aside>"##,
        example_markdown: "Text[^1].\n\n[^1]: The note.",
        status: Status::Emerging,
        since: "1",
        description: "The arrival wash, as a class: `:target` cannot reach a margin aside (no note id by design) or a note inside a closed popover, so `sidenotes.ts` moves this class to whichever presentation of the note the reader landed on — a margin aside on a `#fn-N` deep link or marker click, an endnote `li` inside the expanded sheet. One element carries it at a time; same keyframes and reduced-motion contract as the `li:target` wash.",
    },
    ...
    ComponentEntry {
        ...
        parent: "font-anchor",
        data_attrs: &[],
        example_html: r#"<div class="font-pill" id="fontPill"><button data-scale="small"></button>…</div>"#,
        example_markdown: "",
        status: Status::Confirmed,
        since: "0",
        description: "The reading-size control that opens from the font trigger. Each button carries `data-scale`; the one matching the current size additionally carries the bare class `active`.",
    },
    ComponentEntry {
        class: "font-trigger",
        kind: "instance",
    ...
    ComponentEntry {
        ...
        parent: "font-trigger",
        data_attrs: &[],
        example_html: r#"<button class="font-trigger size-std" aria-expanded="false"></button>"#,
        example_markdown: "",
        status: Status::Confirmed,
        since: "0",
    ...
    ComponentEntry {
        class: "comments-icon",
        kind: "instance",
        parent: "comments-toggle",
        data_attrs: &[],
        example_html: r#"<summary class="comments-toggle"><svg class="comments-icon" width="18" height="18">…</svg></summary>"#,
        example_markdown: "",
        status: Status::Confirmed,
        since: "0",
        description: "Speech-bubble icon inside the comments disclosure summary.",
    },
    ComponentEntry {
        class: "comments-chevron",
        kind: "instance",
        parent: "comments-toggle",
        data_attrs: &[],
        example_html: r#"<summary class="comments-toggle">…<svg class="comments-chevron">…</svg></summary>"#,
        example_markdown: "",
        status: Status::Confirmed,
        since: "0",
        description: "Disclosure arrow inside the comments summary. Rotates with the `<details>` open state; the rotation is the only affordance saying the section collapses.",
    },
    ComponentEntry {
        class: "comment-list",
        kind: "container",
    ...
    ComponentEntry {
        ...
        parent: "comment-item",
        data_attrs: &[],
        example_html: r#"<div class="comment-header"><a class="comment-author">…</a><time class="comment-date">…</time></div>"#,
        example_markdown: "",
        status: Status::Confirmed,
        since: "0",
        description: "Attribution row of a single comment: who wrote it, when, and where it came from.",
    },
    ComponentEntry {
        class: "comment-body",
        kind: "instance",
        parent: "comment-item",
        data_attrs: &[],
        example_html: r#"<div class="comment-body">…</div>"#,
        example_markdown: "",
        status: Status::Confirmed,
        since: "0",
        description: "The comment text itself, separated from the attribution header so the two can be styled independently.",
    },
    ComponentEntry {
        ...
        data_attrs: &[],
        example_html: r#"<a href="…" class="comment-author" rel="nofollow ugc noopener" target="_blank">Name</a>"#,
        example_markdown: "",
        status: Status::Confirmed,
        since: "0",
        description: "The commenter's name, linked to the URL they supplied. Always carries `rel=`nofollow ugc`` — the link is reader-supplied content, not an endorsement by the site.",
    },
    ComponentEntry {
        class: "comment-date",
        kind: "instance",
        parent: "comment-header",
        data_attrs: &[],
        example_html: r#"<time class="comment-date" datetime="2026-08-21T10:00:00Z">21 August 2026</time>"#,
        example_markdown: "",
        status: Status::Confirmed,
        since: "0",
        description: "Publication time of a comment, as a `<time>` element carrying a machine-readable `datetime`.",
    },
    ComponentEntry {
        class: "comment-source-link",
        kind: "instance",
        parent: "comment-header",
        data_attrs: &[],
        example_html: r#"<a class="comment-source-link" href="…" target="_blank" rel="noopener nofollow">…</a>"#,
        example_markdown: "",
        status: Status::Confirmed,
        since: "0",
        description: "Link back to where a syndicated comment originated, for comments moss did not receive directly.",
    },
    ComponentEntry {
    ...
    ComponentEntry {
        class: "review-colophon",
        kind: "standalone",
        parent: "",
        data_attrs: &[],
        example_html: r#"<footer class="review-colophon">…</footer>"#,
        example_markdown: "",
        status: Status::Confirmed,
        since: "0",
        description: "Footer block of a review page carrying the details of the work being reviewed. A `<footer>` because it describes the subject rather than continuing the argument.",
    },
    ComponentEntry {
        class: "review-colophon-details",
        kind: "instance",
        parent: "review-colophon",
        data_attrs: &[],
        example_html: r#"<div class="review-colophon-details">…</div>"#,
        example_markdown: "",
        status: Status::Confirmed,
        since: "0",
        description: "Container for the reviewed work's identifying fields inside the colophon.",
    },
    ComponentEntry {
        class: "review-biblio",
        kind: "instance",
        parent: "review-colophon",
        data_attrs: &[],
        example_html: r#"<div class="review-biblio">…</div>"#,
        example_markdown: "",
        status: Status::Confirmed,
        since: "0",
        description: "Full bibliographic citation of the reviewed work, formatted as one line.",
    },
    ComponentEntry {
        class: "review-rating",
        kind: "instance",
        parent: "review-colophon",
        data_attrs: &[],
        example_html: r#"<div class="review-rating">★★★★☆</div>"#,
        example_markdown: "",
        status: Status::Confirmed,
        since: "0",
        description: "The reviewer's own rating of the work.",
    },
    ComponentEntry {
        class: "review-community-rating",
        kind: "instance",
        parent: "review-colophon",
        data_attrs: &[],
        example_html: r#"<div class="review-community-rating">★ 7.8/10 · 1,204 ratings</div>"#,
        example_markdown: "",
        status: Status::Confirmed,
        since: "0",
        description: "Aggregate rating carried over from the source catalogue, kept visually distinct from the reviewer's own so the two are never read as one judgement.",
    },
    ComponentEntry {
        class: "review-links",
        kind: "instance",
        parent: "review-colophon",
        data_attrs: &[],
        example_html: r#"<nav class="review-links"><a href="…">…</a><span class="review-sep"> · </span><a href="…">…</a></nav>"#,
        example_markdown: "",
        status: Status::Confirmed,
        since: "0",
        description: "Navigation to the reviewed work elsewhere — catalogue entries, purchase pages, the publisher.",
    },
    ComponentEntry {
        class: "review-sep",
        kind: "instance",
        parent: "review-links",
        data_attrs: &[],
        example_html: r#"<span class="review-sep"> · </span>"#,
        example_markdown: "",
        status: Status::Confirmed,
        since: "0",
        description: "Separator between review links. An element rather than a `::before` so it can be hidden when links wrap.",
    },
    ComponentEntry {
        class: "review-colophon-title",
        kind: "instance",
        parent: "review-colophon-details",
        data_attrs: &[],
        example_html: r#"<div class="review-colophon-title">…</div>"#,
        example_markdown: "",
        status: Status::Confirmed,
        since: "0",
        description: "Title of the work being reviewed — not the title of the review itself, which is the page heading.",
    },
    ComponentEntry {
        class: "review-colophon-subtitle",
        kind: "instance",
        parent: "review-colophon-details",
        data_attrs: &[],
        example_html: r#"<div class="review-colophon-subtitle">…</div>"#,
        example_markdown: "",
        status: Status::Confirmed,
        since: "0",
        description: "Subtitle of the reviewed work, rendered only when one is present.",
    },
    ComponentEntry {
        class: "review-colophon-identity",
        kind: "instance",
        parent: "review-colophon-details",
        data_attrs: &[],
        example_html: r#"<div class="review-colophon-identity">…</div>"#,
        example_markdown: "",
        status: Status::Confirmed,
        since: "0",
        description: "The reviewed work's identifier (ISBN, DOI or equivalent), which is what makes a review resolvable to a specific edition.",
    },
    ComponentEntry {
        class: "page-wrapper",
        kind: "container",
        parent: "",
        data_attrs: &[],
        example_html: r#"<div class="page-wrapper"><div class="main-content">…</div></div>"#,
        example_markdown: "",
        status: Status::Confirmed,
        since: "0",
        description: "Outermost wrapper of a generated media-collection page.",
    },
    ComponentEntry {
        class: "main-content",
        kind: "instance",
        parent: "page-wrapper",
        data_attrs: &[],
        example_html: r#"<div class="main-content"><div class="media-grid">…</div></div>"#,
        example_markdown: "",
        status: Status::Confirmed,
        since: "0",
        description: "Primary content column of a media-collection page, inside the page wrapper.",
    },
    ComponentEntry {
        class: "media-grid",
        kind: "instance",
        parent: "main-content",
        data_attrs: &[],
        example_html: r#"<div class="media-grid">…</div>"#,
        example_markdown: "",
        status: Status::Confirmed,
        since: "0",
        description: "The grid of media items on a media-collection page.",
    },
    ComponentEntry {
        class: "media-overlay",
        kind: "instance",
        parent: "media-grid",
        data_attrs: &[],
        example_html: r#"<div class="media-overlay"><p class="media-title">…</p></div>"#,
        example_markdown: "",
        status: Status::Confirmed,
        since: "0",
        description: "Caption overlay drawn over a media thumbnail, typically revealed on hover or focus.",
    },
    ComponentEntry {
        class: "media-title",
        kind: "instance",
        ...
        data_attrs: &[],
        example_html: r#"<p class="media-title">…</p>"#,
        example_markdown: "",
        status: Status::Confirmed,
        since: "0",
        description: "Title of a single media item, inside its overlay.",
    },
    ComponentEntry {
        class: "lightbox",
        kind: "standalone",
        parent: "",
        data_attrs: &[],
        example_html: r#"<div id="lightbox" class="lightbox" hidden tabindex="-1">…</div>"#,
        example_markdown: "",
        status: Status::Confirmed,
        since: "0",
        description: "Full-screen viewer for a media collection. Ships `hidden` and `tabindex=`-1`` so it is out of the tab order until opened.",
    },
    ComponentEntry {
        ...
        parent: "lightbox",
        data_attrs: &[],
        example_html: r#"<div class="lightbox-caption">…</div>"#,
        example_markdown: "",
        status: Status::Confirmed,
        since: "0",
        description: "Caption area of the lightbox, describing the item currently shown.",
    },
    ComponentEntry {
        class: "lightbox-nav",
        kind: "instance",
        ...
        status: Status::Confirmed,
        since: "0",
        description: "Previous/next control in the lightbox. Carries a direction co-class (`lightbox-prev` / `lightbox-next`) and always an `aria-label`, since the visible glyph is a chevron.",
    },
    ComponentEntry {
        ...
        parent: "",
        data_attrs: &[],
        example_html: r#"<nav class="latest-sidebar"><h3>Latest</h3><ul>…</ul></nav>"#,
        example_markdown: "",
        status: Status::Confirmed,
        since: "0",
        description: "Sidebar listing the most recent entries. A `<nav>` because it is a navigational aid, not part of the page's argument.",
    },
    ComponentEntry {
        class: "sidebar-more",
        kind: "instance",
        parent: "latest-sidebar",
        data_attrs: &[],
        example_html: r#"<a href="…" class="sidebar-more">More →</a>"#,
        example_markdown: "",
        status: Status::Confirmed,
        since: "0",
        description: "Link from the latest-entries sidebar to the full listing.",
    },
    ComponentEntry {
        class: "active",
        kind: "instance",
        parent: "",
        data_attrs: &[],
        example_html: r#"<button data-scale="" class="active" aria-label="Standard"></button>"#,
        example_markdown: "",
        status: Status::Confirmed,
        since: "0",
        description: "Bare state co-class marking the currently-selected item in a set — the current page in `.nav-links`, the current size in `.font-pill`. Style it scoped to its container (`.nav-links .active`), never on its own.",
    },
    ComponentEntry {
        class: "has-sidebar-layout",
        kind: "instance",
        parent: "",
        data_attrs: &[],
        example_html: r#"<main class="has-sidebar-layout">…</main>"#,
        example_markdown: "",
        status: Status::Confirmed,
        since: "0",
        description: "Marks a page laid out with a sidebar, so the main column can reserve room for it without the sidebar having rendered yet.",
    },
    ComponentEntry {
        class: "wikilink",
        kind: "instance",
        parent: "",
        data_attrs: &[],
        example_html: r#"<a class="wikilink" href="/other-page/">Other page</a>"#,
        example_markdown: "",
        status: Status::Confirmed,
        since: "0",
